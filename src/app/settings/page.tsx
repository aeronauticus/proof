    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <button
          ...
          className="bg-white rounded-xl p-4 border border-gray-200 hover:border-blue-300 transition-colors text-left"
        >
          <svg className="w-6 h-6 text-amber-500 mb-2" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
          </svg>
          <span className="font-medium text-gray-800 text-sm">Planner Photos</span>
        </button>
        <button
        ...
        >
          ...
          <span className="font-medium text-gray-800 text-sm">Books</span>
        </button>
      </div>
